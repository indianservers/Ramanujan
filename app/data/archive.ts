...
const categoryRows = [
  ["partition-theory", "Partition Theory", "Partition generating functions, congruences, asymptotics and identities.", "icon-partitions.png"],
  ["mock-theta-functions", "Mock Theta Functions", "Ramanujan's final q-series and their later harmonic-Maass-form interpretation.", "icon-mock-theta-functions.png"],
  ["pi-formulas", "Formulas for pi", "Rapidly convergent reciprocal-pi series arising from modular and elliptic methods.", "icon-infinite-series.png"],
  ["ramanujan-theta-functions", "Ramanujan Theta Functions", "General theta functions, special theta functions and representation formulas.", "icon-modular-forms.png"],
  ["modular-equations-elliptic-functions", "Modular Equations and Elliptic Functions", "Modular equations, singular moduli, class invariants and elliptic transformations.", "icon-modular-forms.png"],
  ["rogers-ramanujan-identities", "Rogers-Ramanujan Identities", "The celebrated identities, partition interpretations and modular meaning.", "icon-partitions.png"],
  ["rogers-ramanujan-continued-fraction", "Rogers-Ramanujan Continued Fraction", "A continued fraction tied to q-products and modular equations.", "icon-continued-fractions.png"],
  ["other-continued-fractions", "Other Continued Fractions", "Cubic, gamma-ratio, theta-quotient and modular-equation continued fractions.", "icon-continued-fractions.png"],
  ["q-series-basic-hypergeometric-series", "q-Series and Basic Hypergeometric Series", "Bilateral series, q-binomial identities, partial theta functions and dissections.", "icon-infinite-series.png"],
  ["ramanujan-tau-function", "Ramanujan's Tau Function", "The tau function, discriminant modular form, congruences and later conjectures.", "icon-modular-forms.png"],
  ["ramanujan-sums", "Ramanujan Sums", "Finite trigonometric sums and Ramanujan expansions in arithmetic analysis.", "icon-number-theory.png"],
  ["highly-composite-numbers", "Highly Composite Numbers", "Highly composite and superior highly composite numbers.", "icon-number-theory.png"],
  ["ramanujan-master-theorem", "Ramanujan's Master Theorem", "A theorem connecting formal coefficients with Mellin transforms.", "icon-infinite-series.png"],
  ["infinite-series", "Infinite Series", "Ramanujan's broad work on convergent and transformed infinite series.", "icon-infinite-series.png"],
  ["infinite-products", "Infinite Products", "Eta products, q-products and transformations of infinite products.", "icon-modular-forms.png"],
  ["definite-integrals-integral-transforms", "Definite Integrals and Integral Transforms", "Definite integrals, Mellin transforms and special-function evaluations.", "icon-infinite-series.png"],
  ["gamma-function-identities", "Gamma-Function Identities", "Gamma transformations, ratios and continued fractions.", "icon-infinite-series.png"],
  ["factorial-approximation", "Ramanujan's Factorial Approximation", "Ramanujan's refinement of Stirling-type factorial approximation.", "icon-number-theory.png"],
  ["summation-divergent-series", "Ramanujan Summation of Divergent Series", "Regularised summation methods, distinct from ordinary summation.", "icon-infinite-series.png"],
  ["bernoulli-numbers", "Bernoulli Numbers", "Identities and congruences involving Bernoulli numbers.", "icon-number-theory.png"],
  ["divisor-functions", "Divisor Functions", "Divisor sums, convolution identities and arithmetic functions.", "icon-number-theory.png"],
  ["quadratic-forms", "Representation of Integers by Quadratic Forms", "Representations by squares, triangular numbers and quadratic forms.", "icon-number-theory.png"],
  ["prime-number-theory", "Prime-Number Theory", "Ramanujan primes and theorems related to prime distribution.", "icon-number-theory.png"],
  ["prime-counting-approximation", "Approximation to the Prime-Counting Function", "Approximations and inequalities for prime-counting functions.", "icon-number-theory.png"],
  ["diophantine-equations", "Diophantine Equations", "Integer equations including the Ramanujan-Nagell equation.", "icon-number-theory.png"],
  ["nested-radicals", "Nested Radicals", "Infinite radicals and related identities.", "icon-infinite-series.png"],
  ["approximations-to-constants", "Approximations to Constants", "Striking approximations and near-integer phenomena.", "icon-infinite-series.png"],
  ["asymptotic-expansions", "Asymptotic Expansions", "Asymptotic formulas and expansion methods.", "icon-infinite-series.png"],
  ["ramanujan-polynomials", "Ramanujan Polynomials", "Polynomials associated with Ramanujan's transformations and identities.", "icon-number-theory.png"],
  ["odd-zeta-values", "Odd Zeta Values", "Transformations and formulas involving odd zeta values.", "icon-infinite-series.png"],
  ["eisenstein-modular-series", "Eisenstein and Modular Series", "Eisenstein series, modular series and differential equations.", "icon-modular-forms.png"],
  ["singular-moduli-class-invariants", "Singular Moduli and Class Invariants", "Singular moduli and class invariant evaluations.", "icon-modular-forms.png"],
  ["near-integer-phenomena", "Near-Integer Phenomena", "Near integers such as e^(pi sqrt 163) and their modular explanation.", "icon-infinite-series.png"],
  ["combinatorial-identities", "Combinatorial Identities", "Partition, q-series and finite combinatorial identities.", "icon-partitions.png"],
  ["magic-squares", "Magic Squares", "Ramanujan's recreational arithmetic constructions.", "icon-number-theory.png"],
  ["named-constants", "Named Constants Connected with Ramanujan", "Constants associated with Ramanujan, sometimes named later or historically adjacent.", "icon-number-theory.png"],
  ["broader-named-concepts", "Broader Named Concepts Resulting from His Work", "Concepts named for Ramanujan or developed from his conjectures and influence.", "icon-biography.png"],
] as const;
...
export const categoryHighlights = [
  { name: "Number Theory", href: "/discoveries/category/prime-number-theory", icon: asset("icon-number-theory.png"), formula: "\\tau(n)=\\sum_{d\\mid n}1", description: "The deep mysteries of numbers and their hidden patterns." },
  { name: "Infinite Series", href: "/discoveries/category/infinite-series", icon: asset("icon-infinite-series.png"), formula: "1+\\frac{1}{1}+\\frac{1}{2}+\\frac{1}{3}+\\cdots", description: "Endless sums that unfold unexpected truths." },
  { name: "Continued Fractions", href: "/discoveries/category/other-continued-fractions", icon: asset("icon-continued-fractions.png"), formula: "K=\\cfrac{1}{1+\\cfrac{1}{1+\\cfrac{1}{1+\\cdots}}}", description: "Beautiful expansions that continue without end." },
  { name: "Partitions", href: "/discoveries/category/partition-theory", icon: asset("icon-partitions.png"), formula: "p(5)=7", description: "Counting the ways numbers can be decomposed." },
  { name: "Mock Theta Functions", href: "/discoveries/category/mock-theta-functions", icon: asset("icon-mock-theta-functions.png"), formula: "f(q)=1+\\sum q^{n^2}", description: "Mysterious functions that puzzled and inspired." },
  { name: "Modular Forms", href: "/discoveries/category/eisenstein-modular-series", icon: asset("icon-modular-forms.png"), formula: "f(\\tau+1)=f(\\tau)", description: "Symmetries that connect mathematics at the highest level." },
];
...
export const notebooks: NotebookRecord[] = [
  {
    ...
    summary: "Ramanujan's three notebooks contain a vast body of results, many written without the formal proofs expected in printed papers. They remain a central source for studying his mathematical imagination.",
  ...
  },
  {
    ...
    summary: "The Lost Notebook is associated with Ramanujan's final period and contains material that later became central to mock theta functions, q-series and related modern research.",
